...
var __msgPrefix$1 = __key$1 + _$7.now() + _$7.random(1, Number.MAX_SAFE_INTEGER);
var TypeMsg$1 = {
...
var __msgPrefix = __key + _$6.now() + _$6.random(1, Number.MAX_SAFE_INTEGER);
var TypeMsg = {
...
uu$.getJQuery$ = function () {
  var $ = window.jQuery || window.$ || undefined;
  console.assert(_$11.isObject($), 'Must be loaded jQuery library first \n');
  return $
};
...
var util = {};
util = _$10.extend(util, common$1);
util = _$10.extend(util, config);
util = _$10.extend(util, webHelper);
util = _$10.extend(util, communication);
util = _$10.extend(util, googleLangIDMaps);
util = _$10.extend(util, loadLanguage);
util = _$10.extend(util, loaderWrapper);
util = _$10.extend(util, compatibilityWrapper);
util = _$10.extend(util, update);
