import { TypeNativeMessageType, TypeTriggerMsg, TaskMethodWay, task } from './task'
...
const ClientIOType = {
  TaskIO: 'io.task',      // 适用于Node服务器使用的Socket.IO
  BundleIO: 'io.bundle'    // 适用于Node服务器使用的Engine.IO
}
